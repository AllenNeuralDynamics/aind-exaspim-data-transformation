...
class TestImarisToZarrWriter(unittest.TestCase):
    ...
    def test_basic_conversion(
        ...
        mock_dask_arrays = [
            MagicMock(
                shape=(100, 200, 300), chunksize=(64, 64, 64), dtype=np.uint16
            ),
            MagicMock(
                shape=(50, 100, 150), chunksize=(64, 64, 64), dtype=np.uint16
            ),
            MagicMock(
                shape=(25, 50, 75), chunksize=(64, 64, 64), dtype=np.uint16
            ),
        ]
